...
<html lang="en" dir="ltr">
  ...
  @section('content')
  <div class="container">
    <h3 class="my-4">Edit Order Cost</h3>
    <!-- looping the keys -->
    <div class="table-responsive">
      <form class="" action="{{route('order_cost/update')}}" method="post">
        {{csrf_field()}}
       ...
       <a href="{{route('order_cost')}}" type="button" class="btn btn-danger float-right" name="button">Cancel</a>
      </form>
  @endsection
  </body>
</html>
